...
{
    /// <summary>
    /// Phone application page for Connection_Detail.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class Connection_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Connection_Detail and all its components.
        /// </summary>
        public Connection_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaConnection_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaConnection_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaConnection_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaConnection_Detail(PanoramaConnection_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaConnection_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<IConnectionCollection>();
				AddHomeAppBarButton();
				...
				((Connection_DetailViewModel)DataContext).CurrentConnectionCollectionSchema = pinnedItem;				
			}
		}
