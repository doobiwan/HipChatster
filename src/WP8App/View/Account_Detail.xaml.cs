...
{
    /// <summary>
    /// Phone application page for Account_Detail.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class Account_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Account_Detail and all its components.
        /// </summary>
        public Account_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaAccount_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaAccount_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaAccount_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaAccount_Detail(PanoramaAccount_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaAccount_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<IAccountCollection>();
				AddHomeAppBarButton();
				...
				((Account_DetailViewModel)DataContext).CurrentAccountCollectionSchema = pinnedItem;				
			}
		}
