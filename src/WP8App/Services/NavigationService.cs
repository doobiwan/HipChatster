...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        {
            { typeof(IRooms_ListViewModel), "/View/Rooms_List.xaml" },
            { typeof(IPeople_DetailViewModel), "/View/People_Detail.xaml" },
            { typeof(IRooms_DetailViewModel), "/View/Rooms_Detail.xaml" },
            { typeof(IConnection_ListViewModel), "/View/Connection_List.xaml" },
            { typeof(IConnection_DetailViewModel), "/View/Connection_Detail.xaml" },
            { typeof(IAccount_ListViewModel), "/View/Account_List.xaml" },
            { typeof(IAccount_DetailViewModel), "/View/Account_Detail.xaml" },
        };
